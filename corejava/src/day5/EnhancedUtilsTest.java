...
class EnhancedUtilsTest {
	...
	void testListConventional() {
		List<Integer> nums = new ArrayList<Integer>();                // this list can change
		nums.add(1);
		nums.add(2);
		nums.add(3);
		System.out.println(nums);
		
		List<Integer> nums1 = Arrays.asList(1,2,3);                   // this list cannot change it is immutable in this style
